...
tidy_snp_locus_data <-
  read_csv("data/tidy_snp_locus/positional/agglom_rsquared25_ld_loci.csv")
...
for (chr_i in all_chr) {
  ...
  write_csv(tidy_locus_summary,
            paste0("data/locus_level_pvals/positional/rsquared25/chr",
...
# Load the tidy SNP gene-set data:
tidy_snp_locus_data <-
  read_csv("data/tidy_snp_locus/positional/agglom_rsquared50_ld_loci.csv")
...
for (chr_i in all_chr) {
  ...
  write_csv(tidy_locus_summary,
            paste0("data/locus_level_pvals/positional/rsquared50/chr",
                   chr_i, "_locus_summary.csv"))
...
# Load the tidy SNP gene-set data:
tidy_snp_locus_data <-
  read_csv("data/tidy_snp_locus/positional/agglom_rsquared75_ld_loci.csv")
...
for (chr_i in all_chr) {
  ...
  write_csv(tidy_locus_summary,
            paste0("data/locus_level_pvals/positional/rsquared75/chr",
                   chr_i, "_locus_summary.csv"))
