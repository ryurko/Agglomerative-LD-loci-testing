...
save_plot("figures/suppl/f_rsquared50_adapt_disc_plot.jpg",
          adapt_dotplot, ncol = 3, nrow = 2)
save_plot("figures/suppl/f_rsquared50_adapt_disc_plot.pdf",
          adapt_dotplot, ncol = 3, nrow = 2)
