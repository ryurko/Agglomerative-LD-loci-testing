# PURPOSE: Initialize the AdaPT-CV ASD, SCZ, and EA results for Positional + eSNPs data
...
saveRDS(asd_adapt_results,
        "data/adapt_results/positional_esnps/asd_rsquared25_xgb_cv.rds")
...
saveRDS(scz_adapt_results,
        "data/adapt_results/positional_esnps/scz_rsquared25_xgb_cv.rds")
...
saveRDS(ea_adapt_results,
        "data/adapt_results/positional_esnps/ea_rsquared25_xgb_cv.rds")
...
# Update the settings
model_args <- list("nrounds300md1eta04gamma0" = list("nrounds" = 300,
                                                     "max_depth" = 1,
                                                     "eta" = 0.04,
                                                     "gamma" = 0,
                                                     "verbose" = 0,
...
saveRDS(asd_adapt_results,
        "data/adapt_results/positional_esnps/asd_rsquared50_xgb_cv.rds")
...
saveRDS(scz_adapt_results,
        "data/adapt_results/positional_esnps/scz_rsquared50_xgb_cv.rds")
