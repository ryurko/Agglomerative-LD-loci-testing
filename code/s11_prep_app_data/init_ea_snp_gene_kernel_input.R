...
# Starting with r^2 = 0.25 for ea using Positional + eSNPs:
...
pos_gene_ld_loci_table <-
  read_csv("data/adapt_results/positional/snp_gene_tables/ea_rsquared25_gene_ld_loci_table.csv")
...
# First the positional SNP to genes:
...
pos_snp_gene_results <- tidy_pos_snp_to_gene_table %>%
  ...
  left_join(pos_gene_ld_loci_table, by = "ensembl_id")

# Save this table with gene info:
write_csv(pos_snp_gene_results,
          "data/kernel_smoothing/ea/input/positional/positional_snp_gene_ld_loci_data.csv")
...
write_csv(pos_snp_ld_loci_results,
          "data/kernel_smoothing/ea/input/positional/positional_snp_ld_loci_data.csv")
...
write_csv(filter(gene_type_table,
          ...
          "data/kernel_smoothing/ea/input/positional/gene_info.csv")
...
write_csv(filter(gene_type_table,
          ...
          "data/kernel_smoothing/ea/input/positional_esnps/gene_info.csv")
...
write_csv(pos_esnps_loc_snp_gene_results,
          "data/kernel_smoothing/ea/input/positional_esnps/positional_snp_gene_ld_loci_data.csv")
...
write_csv(pos_esnps_loc_snp_ld_loci_results,
          "data/kernel_smoothing/ea/input/positional_esnps/positional_snp_ld_loci_data.csv")
...
write_csv(pos_esnps_fun_snp_gene_results,
          "data/kernel_smoothing/ea/input/positional_esnps/functional_snp_gene_ld_loci_data.csv")
