# PURPOSE: Generate the AdaPT CV results for Positional + eSNPs
...
model_args <- list("nrounds400md1eta06gamma0" = list("nrounds" = 400,
                                                     "max_depth" = 1,
                                                     "eta" = 0.06,
                                                     "gamma" = 0,
                                                     "verbose" = 0,
                                                     "nthread" = 5),
                   "nrounds250md2eta05gamma0" = list("nrounds" = 250,
                                                     "max_depth" = 2,
                                                     "eta" = 0.05,
                                                     "gamma" = 0,
                                                     "verbose" = 0,
...
saveRDS(asd_adapt_results,
        "data/adapt_results/positional_esnps/asd/rsquared25_xgb_cv.rds")
...
saveRDS(scz_adapt_results,
        "data/adapt_results/positional_esnps/scz/rsquared25_xgb_cv.rds")
...
saveRDS(ea_adapt_results,
        "data/adapt_results/positional_esnps/ea/rsquared25_xgb_cv.rds")
...
model_args <- list("nrounds450md1eta06gamma0" = list("nrounds" = 450,
                                                     ...
                                                     "verbose" = 0,
                                                     "nthread" = 5),
                   "nrounds300md2eta05gamma0" = list("nrounds" = 300,
                                                     "max_depth" = 2,
                                                     "eta" = 0.05,
                                                     "gamma" = 0,
                                                     "verbose" = 0,
...
saveRDS(asd_adapt_results,
        "data/adapt_results/positional_esnps/asd/rsquared50_xgb_cv.rds")
...
saveRDS(scz_adapt_results,
        "data/adapt_results/positional_esnps/scz/rsquared50_xgb_cv.rds")
...
saveRDS(ea_adapt_results,
        "data/adapt_results/positional_esnps/ea/rsquared50_xgb_cv.rds")
...
model_args <- list("nrounds450md1eta05gamma0" = list("nrounds" = 450,
                                                     ...
                                                     "verbose" = 0,
                                                     "nthread" = 5),
                   "nrounds250md2eta04gamma0" = list("nrounds" = 250,
                                                     "max_depth" = 2,
                                                     "eta" = 0.04,
                                                     "gamma" = 0,
                                                     "verbose" = 0,
...
saveRDS(asd_adapt_results,
        "data/adapt_results/positional_esnps/asd/rsquared75_xgb_cv.rds")
...
saveRDS(scz_adapt_results,
        "data/adapt_results/positional_esnps/scz/rsquared75_xgb_cv.rds")
...
saveRDS(ea_adapt_results,
        "data/adapt_results/positional_esnps/ea/rsquared75_xgb_cv.rds")
